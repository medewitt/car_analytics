...
link="https://www.cargurus.com/Cars/inventorylisting/viewDetailsFilterViewInventoryListing.action?sourceContext=carGurusHomePage_false_0&formSourceTag=112&newSearchFromOverviewPage=true&inventorySearchWidgetType=AUTO&entitySelectingHelper.selectedEntity=&entitySelectingHelper.selectedEntity2=&zip=27106&distance=100&searchChanged=true&modelChanged=true&filtersModified=true"

raw_data = "_data_{}_raw.csv".format(data_name)
clean_data = "_data_{}_clean.csv".format(data_name)
...
driver = webdriver.PhantomJS(executable_path='/Users/michael/Scrape/phantomjs')
driver.get(link)
